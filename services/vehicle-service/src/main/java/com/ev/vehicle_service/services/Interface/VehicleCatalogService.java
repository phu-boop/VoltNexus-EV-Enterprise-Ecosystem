...
public interface VehicleCatalogService {
        ...
        // History & Audit
        List<PriceHistoryDto> getVariantPriceHistory(Long variantId);

        List<VariantHistoryDto> getVariantAuditHistory(Long variantId);
        ...
        VehicleModel createModelWithVariants(CreateModelRequest request); // Tạo 1 mẫu xe mới (có thể thêm 1 vài phiên
                                                                          // bản
                                                                          // đi kèm theo)

        VehicleVariant createVariant(Long modelId, CreateVariantRequest request, String createdByEmail); // Tạo phiên
                                                                                                         // bản xe
                                                                                                         // mới
         ...
         */
        List<com.ev.vehicle_service.dto.response.FeatureVariantDto> getVariantsByFeatureId(Long featureId);
