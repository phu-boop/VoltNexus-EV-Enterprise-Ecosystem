...
public class PromotionController {
    ...
    public ResponseEntity<ApiRespond<PromotionResponse>> createPromotion(@RequestBody PromotionRequest request) {
        ...
        return ResponseEntity
                .ok(ApiRespond.success("Promotion created successfully", promotionMapper.toResponse(saved)));
    }
    ...
    public ResponseEntity<ApiRespond<PromotionResponse>> updatePromotion(@PathVariable UUID id,
        ...
        return ResponseEntity
                .ok(ApiRespond.success("Promotion updated successfully", promotionMapper.toResponse(updated)));
    }
    ...
    public ResponseEntity<ApiRespond<PromotionResponse>> authenticPromotion(@PathVariable UUID id) {
        ...
        return ResponseEntity
                .ok(ApiRespond.success("Promotion authenticated successfully", promotionMapper.toResponse(updated)));
    }
    ...
    public ResponseEntity<ApiRespond<PromotionResponse>> getPromotionById(@PathVariable UUID id) {
        ...
        return ResponseEntity
                .ok(ApiRespond.success("Promotion fetched successfully", promotionMapper.toResponse(promotion)));
    }
    ...
    public ResponseEntity<ApiRespond<List<PromotionResponse>>> getAllPromotions() {
        ...
        return ResponseEntity.ok(
                ApiRespond.success("All promotions fetched successfully", promotionMapper.toResponseList(promotions)));
    }
    ...
    public ResponseEntity<ApiRespond<List<PromotionResponse>>> getPromotionsByStatus(
        ...
        return ResponseEntity.ok(
                ApiRespond.success("Promotions fetched by status successfully", promotionMapper.toResponseList(list)));
    }
