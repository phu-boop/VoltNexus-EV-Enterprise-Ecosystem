...
public class TestController {
        ...
        public ResponseEntity<ApiRespond<DataStatus>> getDataStatus() {
                ...
                DataStatus status = DataStatus.builder()
                                ...
                                .message(salesCount > 0 ? "Data available for forecasting"
                                                : "No data - please seed data first")
                                .build();
                ...
                try {
                        ...
                        for (long variantId = 1; variantId <= variants; variantId++) {
                                ...
                                for (int day = 0; day < days; day++) {
                                        LocalDateTime saleDate = LocalDateTime.now().minusDays((long) days - day);
                                        ...
                                        if (quantity > 0) {
                                                ...
                                                SalesHistory sales = SalesHistory.builder()
                                                                ...
                                                                .region(region)
                                                                .quantity(quantity)
                                                                .totalAmount(BigDecimal.valueOf(quantity * 30000000L)) // 30M
                                                                                                                       // VND
                                                                                                                       // per
                                                                                                                       // car
                                                                .saleDate(saleDate)
