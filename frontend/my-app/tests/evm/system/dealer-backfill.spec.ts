...
test.describe('Function 109: backfillDealerCache', () => {
  ...
  test('ITC_5.109.1 Test backfill dealer cache successfully (Đồng bộ Đại lý thành công)', async ({ page }) => {
    ...
    // 3. Click the green button labeled "1. Đồng bộ Đại lý (Dealers)".
    // Lấy đích danh nút màu xanh dương dựa trên text
    ...
    // Lắng nghe sự xuất hiện của thông báo thành công cho Đại lý
