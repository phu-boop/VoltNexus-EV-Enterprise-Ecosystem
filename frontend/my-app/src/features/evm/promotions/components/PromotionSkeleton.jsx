    ...
    {[...Array(5)].map((_, index) => (
      <tr key={index} className="hover:bg-gray-50">
        <td className="px-6 py-4 whitespace-nowrap w-12 text-center">
          <div className="h-4 w-4 bg-slate-100 rounded animate-pulse inline-block"></div>
        </td>
        ...
        <td className="px-6 py-4 whitespace-nowrap">
          <div className="space-y-1">
            <div className="h-6 bg-slate-100 rounded w-16 animate-pulse"></div>
        ...
        <td className="px-6 py-4">
          <div className="space-y-2">
            <div className="flex items-center">
              <div className="h-4 w-4 bg-slate-100 rounded mr-2 animate-pulse"></div>
        ...
        <td className="px-6 py-4 whitespace-nowrap">
          <div className="h-6 bg-slate-100 rounded w-24 animate-pulse"></div>
        </td>
        <td className="px-6 py-4 whitespace-nowrap text-right">
          <div className="h-8 bg-slate-100 rounded w-24 ml-auto animate-pulse"></div>
        </td>
      </tr>
    ))}
  </>
